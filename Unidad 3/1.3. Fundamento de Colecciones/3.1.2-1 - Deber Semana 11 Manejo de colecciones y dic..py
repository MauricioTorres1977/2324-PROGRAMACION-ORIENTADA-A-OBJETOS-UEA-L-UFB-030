...
class Inventario:
    ...
    def guardar_inventario_en_archivo(self, archivo):
    ...
    def agregar_producto(self, producto):
        if producto.id_producto in self.productos:
            ...
            self.guardar_inventario_en_archivo("inventario.dat")
...
def menu():
    ...
    inventario.cargar_inventario_desde_archivo("inventario.dat")
    while True:
