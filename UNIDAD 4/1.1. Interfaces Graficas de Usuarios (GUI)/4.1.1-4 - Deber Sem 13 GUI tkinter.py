...
class AplicacionGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Aplicación GUI Básica - Design M.TORRES. Marzo 2024")
        self.root.geometry("600x400")  # Ajusta el tamaño de la ventana a 300x300
        ...
        # Componentes GUI
        self.etiqueta = tk.Label(root, text="Ingrese información en el casillero:")
        self.etiqueta.pack()
        ...
        # Agregar etiqueta al final de la ventana
        self.etiqueta_final = tk.Label(root, text="UNIVERSIDAD ESTATAL AMAZONICA - TECNOLOGIAS DE LA INFORMACION")
        self.etiqueta_final.pack(side=tk.BOTTOM)
